...
# 2. Injeção de CSS e HTML customizado para o Cabeçalho Azul Royal e Efeito Hover
st.markdown("""
...
<style>
    ...
    /* Mini Cabeçalho que surge com o HOVER */
    .hover-menu {
        max-height: 0;
        opacity: 0;
        overflow: hidden;
    ...
    .menu-links a:hover {
        color: #FFD700 !important; /* Destaque ao passar o mouse nas opções */
    }

    /* Estilização da barra de utilidades (Busca, Login, Favoritos, Carrinho) */
    .action-bar {
        display: flex;
...
<div class="header-container">
    <div class="top-bar">
        ...
        <div class="top-links">
            🌐 <select style="color:white; background:#4169E1; border:none;">
                <option>PT</option>
                <option>EN</option>
                <option>ES</option>
            </select>
...
# 3. BARRA DE AÇÕES (BUSCA, LOGIN, FAVORITOS, CARRINHO)
...
# 4. ESTADO DA APLICAÇÃO & LÓGICA DE PRODUTOS
...
# --- SIDEBAR (BARRA LATERAL DE CARRINHO E FILTROS) ---
with st.sidebar:
